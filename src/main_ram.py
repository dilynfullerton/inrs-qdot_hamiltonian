...
QD_GaAs_HAM = HamiltonianQD(
    ...
    expected_roots_mu_l={
        0: (1, [1.30, 2.30, 3.30, 4.31, 4.42]),
        1: (0, [.0001, 1.55, 2.15, 2.83, 3.80, 4.79]),
        2: (0, [.0001, 1.99, 2.95, 3.54, 4.30, 5.26]),
        3: (0, [.0000001, 2.39, 3.45, 4.30, 4.90, 5.75]),
        4: (0, [.0000001, 2.75, 3.88, 4.85, 5.65, 6.30]),
    },
    num_n=3,
    num_l=2,
)
